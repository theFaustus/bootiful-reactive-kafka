...
tasks.withType<KotlinCompile> {
    ...
    mustRunAfter("generateTestAvroJava")
}
...
tasks.withType<GenerateAvroJavaTask> {
    ...
    setOutputDir(file("${projectDir}\\build\\generated\\source\\avro\\main\\java"))
}
...
sourceSets {
    test {
        ...
        java {
            srcDirs("${projectDir}\\build\\generated\\source\\avro\\main\\java")
        }
    }
    main {
        kotlin {
